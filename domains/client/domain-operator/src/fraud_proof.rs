...
use sp_domains::{
    DomainId, DomainsApi, DomainsDigestItem, ExtrinsicDigest, FraudProofStorageKeyProviderInstance,
    FraudProofStorageKeyRequest, HeaderHashingFor, InvalidBundleType, RuntimeId,
};
...
use sp_domains_fraud_proof::fraud_proof::{
    ...
    FraudProofV2, FraudProofVariant, InvalidBlockFeesProof, InvalidBlockFeesProofV2,
    InvalidBundlesFraudProof, InvalidBundlesProofData, InvalidBundlesProofV2,
    InvalidDomainBlockHashProof, InvalidDomainBlockHashProofV2, InvalidExtrinsicsRootProof,
    InvalidExtrinsicsRootProofV2, InvalidStateTransitionProof, InvalidStateTransitionProofV2,
    InvalidTransfersProof, InvalidTransfersProofV2, ValidBundleDigest, ValidBundleProofV2,
};
...
type FraudProofV2For<CBlock, DomainHeader> =
    FraudProofV2<NumberFor<CBlock>, <CBlock as BlockT>::Hash, DomainHeader, H256>;
...
where
    ...
    CClient: HeaderBackend<CBlock>
        ...
        + 'static,
    CClient::Api: DomainsApi<CBlock, Block::Header> + MmrApi<CBlock, H256, NumberFor<CBlock>>,
    ...
    E: CodeExecutor,
{
    ...
    pub(crate) fn generate_invalid_state_transition_proof_v2(
        &self,
        domain_id: DomainId,
        execution_phase: ExecutionPhase,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        bad_receipt_trace_length: usize,
        bad_receipt_hash: Block::Hash,
    ) -> Result<FraudProofV2For<CBlock, Block::Header>, FraudProofError> {
        let block_hash = local_receipt.domain_block_hash;
        let block_number = local_receipt.domain_block_number;
        let header = self.header(block_hash)?;
        let parent_header = self.header(*header.parent_hash())?;
        ...
        let invalid_state_transition_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidStateTransition(InvalidStateTransitionProofV2 {
                bad_receipt_hash,
                execution_proof,
                execution_phase,
            }),
    ...
    pub(crate) fn generate_valid_bundle_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        mismatch_type: BundleMismatchType,
        ...
        let valid_bundle_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: Some(mmr_proof),
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::ValidBundle(ValidBundleProofV2 {
                bad_receipt_hash,
                bundle_with_proof,
            }),
        };
    ...
    pub(crate) fn generate_invalid_domain_extrinsics_root_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        bad_receipt_hash: Block::Hash,
        ...
        let invalid_domain_extrinsics_root_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: Some(mmr_proof),
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidExtrinsicsRoot(InvalidExtrinsicsRootProofV2 {
                bad_receipt_hash,
                valid_bundle_digests,
    ...
    pub(crate) fn generate_invalid_bundle_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        mismatch_type: BundleMismatchType,
        ...
        let invalid_bundle_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: Some(mmr_proof),
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidBundles(InvalidBundlesProofV2 {
                bad_receipt_hash,
                bundle_index,
    ...
    pub(crate) fn generate_invalid_block_fees_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        bad_receipt_hash: Block::Hash,
        ...
        let invalid_block_fees_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidBlockFees(InvalidBlockFeesProofV2 {
                bad_receipt_hash,
                storage_proof,
            }),
        };
    ...
    pub(crate) fn generate_invalid_transfers_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        bad_receipt_hash: Block::Hash,
        ...
        let invalid_transfers_proof = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof,
            proof: FraudProofVariant::InvalidTransfers(InvalidTransfersProofV2 {
                bad_receipt_hash,
                storage_proof,
            }),
        };
    ...
    pub(crate) fn generate_invalid_domain_block_hash_proof_v2(
        &self,
        domain_id: DomainId,
        local_receipt: &ExecutionReceiptFor<Block, CBlock>,
        bad_receipt_hash: Block::Hash,
        ...
        let invalid_domain_block_hash = FraudProofV2 {
            domain_id,
            maybe_mmr_proof: None,
            maybe_domain_runtime_code_proof: None,
            proof: FraudProofVariant::InvalidDomainBlockHash(InvalidDomainBlockHashProofV2 {
                bad_receipt_hash,
                digest_storage_proof,
            }),
        };
